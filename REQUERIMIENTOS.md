...
> **Documento de requerimientos** · Versión 1.7 · Agosto 2026
> Estado de implementación: **F0 a F4 listas**; siguiente F5 (portal docente).
...
| **F4 · Novedades y cierre** ✅ | Compilación idempotente del mes, ruteo automático a planilla Oficial o Interna según la fuente de pago del cargo, filtro por impacto en haberes, revisión por persona, checklist "informada", cierre que congela con reapertura auditada, export a Excel/CSV/PDF con las columnas de la planilla y acceso de solo lectura para el liquidador. | **Hecha.** El fin de mes baja de días a minutos. |
